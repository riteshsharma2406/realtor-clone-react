    ...
    <section>
      ...
      px-6 py-12 max-w-6xl mx-auto">
        <div className='md:w-[67%] lg:w-[50%] mb-12 md:mb-6'>
          <img src="https://images.unsplash.com/flagged/photo-1564767609342-620cb19b2357?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8a2V5fGVufDB8fDB8fHww&auto=format&fit=crop&w=1000&q=60" alt="key" 
...
{/* full name  */}
          <input className="w-full px-4 py-2 mb-6 text-xl text-gray-700
...
{/* forget password  */}
            ...
            text-sm sm:text-lg'>
              ...
              <p>
                ...
                transition duration-200 ease-in-out ml-1'>Forget Password?</Link>
              </p>
            </div>

            <button type="submit" className='w-full bg-blue-600 text-white px-7 py-3 mt-7 text-sm font-medium uppercase 
            rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800'>Sign Up</button>
